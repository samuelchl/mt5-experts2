...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title         ="TestW2";    // Document name
ulong                    Expert_MagicNumber   =93210807;    //
...
//--- Creating filter CSignalFrAMA
   CSignalFrAMA *filter0=new CSignalFrAMA;
   if(filter0==NULL)
     {
      //--- failed
...
//--- Set filter parameters
   filter0.PeriodMA(Signal_FraMA_PeriodMA);
   filter0.Shift(Signal_FraMA_Shift);
   filter0.Applied(Signal_FraMA_Applied);
   filter0.Weight(Signal_FraMA_Weight);
